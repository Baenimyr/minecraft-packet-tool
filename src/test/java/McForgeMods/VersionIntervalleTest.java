...
class VersionIntervalleTest {
	...
	public void dependances() {
		Map<String, VersionIntervalle> intervalles = VersionIntervalle
				.lectureDependances(Collections.singletonList("mod@[2.54.3," + "2.55)"));
	...
	public void intersection() {
		final Version v = new Version(1, 6, 2);
		VersionIntervalle i1 = new VersionIntervalle(null, v, true, false);
		VersionIntervalle i2 = new VersionIntervalle(v, null, true, false);
		
		VersionIntervalle mix = i1.intersection(i2);
		assertEquals(v, mix.minimum());
		assertEquals(v, mix.maximum());
		assertTrue(mix.inclut_min);
		assertFalse(mix.inclut_max);
